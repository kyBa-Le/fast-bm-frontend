      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-slate-100 mb-4">
        <div>
          ...
          <p className="text-xs text-slate-500">
            Nhấn vào từng mục để xem chi tiết, chỉnh sửa hoặc xoá
          </p>
        </div>
        ...
        <div className="flex items-center gap-1.5 bg-slate-100 p-1 rounded-xl border border-slate-200 text-xs font-semibold">
          <button
            ...
            className={`px-3 py-1.5 rounded-lg transition cursor-pointer ${filterType === 'ALL'
          ...
          <button
            ...
            className={`px-3 py-1.5 rounded-lg transition cursor-pointer ${filterType === 'EXPENSE'
          ...
          <button
            ...
            className={`px-3 py-1.5 rounded-lg transition cursor-pointer ${filterType === 'INCOME'
          ...
          {filtered.map((tx) => {
            ...
            return (
              <div
                ...
                className="flex items-center justify-between p-3.5 rounded-xl bg-slate-50/60 hover:bg-slate-100/90 border border-slate-200/80 hover:border-slate-300 transition group cursor-pointer"
              >
                ...
                {/* Right: Formatted Amount & Chevron indicator (NO delete button here) */}
